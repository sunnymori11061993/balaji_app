...
class ManuProfileScreen extends StatefulWidget {
  @override
  _ManuProfileScreenState createState() => _ManuProfileScreenState();
}

class _ManuProfileScreenState extends State<ManuProfileScreen> {
