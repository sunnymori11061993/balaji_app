...
final List<String> imgList = [
  ...
  "https://i.pinimg.com/originals/70/67/5f/70675f0eda0a15d8eaa1c44950421a8a.jpg",
  "https://instant-bollywood.s3.amazonaws.com/wp-content/uploads/2020/07/18142049/A4010616-5D34-48CC-B6A0-E0075C8B1591-642x1024.jpeg",
];
  ...
  _addToWishlist() async {
    try {
      ...
      if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
        ...
        Services.postForSave(apiname: 'insert_data_api/wishlist', body: body)
